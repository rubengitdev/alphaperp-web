...
const PYTH_SYMBOLS = [
    ...
    {
        symbol: 'NFLX',
        feedId: '8376cfd7ca8bcdf372ced05307b24dced1f15b1afafdeff715664598f15a3dd2',
    },
    {
        symbol: 'AMD',
        feedId: '3622e381dbca2efd1859253763b1adc63f7f9abb8e76da1aa8e638a57ccde93e',
    },
    {
        symbol: 'COIN',
        feedId: 'fee33f2a978bf32dd6b662b65ba8083c6773b494f8401194ec1870c640860245',
    },
    {
        symbol: 'SPY',
    ...
    {
        symbol: 'GME',
        feedId: '6f9cd89ef1b7fd39f667101a91ad578b6c6ace4579d5f7f285a4b06aa4504be6',
    },
];
...
export const AssetList: FC<AssetListProps> = ({
    ...
    const [assetMap, setAssetMap] =
        useState<Record<string, Asset>>(buildInitialMap);
    ...
    useEffect(() => {
        ...
        async function fetchPyth() {
            try {
                ...
                const parsedData =
                    await hermesRef.current.getLatestPriceUpdates(feedIds);
                ...
                if (parsed) {
                    setAssetMap((prev) => {
                        ...
                        parsed.forEach((feed: any) => {
                            const symInfo = PYTH_SYMBOLS.find(
                                (p) => p.feedId === feed.id,
                            );
                            if (symInfo) {
                                const price =
                                    feed.price.price * 10 ** feed.price.expo;
                                next[symInfo.symbol] = {
                                    ...next[symInfo.symbol],
                                    price,
                                };
        ...
        async function fetchStockChanges() {
            try {
                ...
                const res = await fetch(
                    `${apiUrl}/stocks/change?symbols=${symbolsStr}`,
                );
    ...
    useEffect(() => {
        if (hasAutoSelected.current || !onSelectAsset || selectedAssetId)
            return;
            ...
            >
                <button
                    ...
                    style={{
                        ...
                        color: activeTab === 'crypto' ? '#20D9C5' : '#A3A3A3',
                        border: 'none',
                        borderBottom:
                            activeTab === 'crypto'
                                ? '2px solid #20D9C5'
                ...
                <button
                    ...
                    style={{
                        ...
                        padding: '0.5rem',
                        backgroundColor: 'transparent',
                        color: activeTab === 'stocks' ? '#20D9C5' : '#A3A3A3',
                        border: 'none',
                        borderBottom:
                            activeTab === 'stocks'
                                ? '2px solid #20D9C5'
                ...
                return (
                    ...
                    >
                        ...
                        <div style={{ textAlign: 'right' }}>
                            ...
                            <div
                                style={{
                                    color: isPositive ? '#20D9C5' : '#F87171',
                                    fontSize: '0.75rem',
                                    marginTop: '0.2rem',
                                }}
                            >
